...
tem = df.copy()
head_df = df.head()
# symptoms = ["sharp chest pain", "depression", "diarrhea", "cough"]
# symptoms = ["arm cramp", "lower body pain"]
# symptoms = ['depression', 'anxiety', 'nervousness']
# symptoms = ["headache"]
test = df.groupby(['diseases'])
# print(Symptom_list)
symptoms = ["irregular heartbeat","depression", "insomnia", "sharp chest pain"]
#
# for symptom in symptoms:
#     if symptom not in Symptom_list:
#         symptoms.remove(symptom)
# for ind, s in enumerate(symptoms):
#     found = False
#     for sl in enumerate(Symptom_list):
#         if s == sl:
#             found = True
#             # print(s,sl)
#             break
